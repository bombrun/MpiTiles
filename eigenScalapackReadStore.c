 ...
 * mpicc -O1 -o eigen.mpi eigenScalapackReadStore.c mpiutil.c normals.c matrixBlockStore.c matrixScalapackStore.c -L/opt/scalapack/lib/ -lscalapack -llapack -lrefblas -lgfortran -lm
 * run with
 * mpirun -n 4 eigen.mpi 4 5
 * 
 * assume that 
