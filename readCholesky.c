 ...
 */
void solveRhs(int mype, int npe, double * rhs, int n_blocks, int scalapack_size, int N, const char* scaStore_location,double **out);
 ...
 * icc -O1 -o readchol.mpi -I/sw/global/compilers/intel/2013/mkl/include readCholesky.c mpiutil.c normals.c matrixBlockStore.c matrixScalapackStore.c     -lmpi -mkl -lmkl_scalapack_lp64 -lmkl_blacs_sgimpt_lp64 -lmkl_intel_lp64 -lmkl_sequential -lmkl_core 
 * 
 * bsub -Is -n 16 mpirun -np 16 ./readchol.mpi 100 1
*/
