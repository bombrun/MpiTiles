 ...
 *
 * Compile on venus 
 * icc -O1 -o diagchol.mpi -I/sw/global/compilers/intel/2013/mkl/include myScalapackReadStore.c mpiutil.c normals.c matrixBlockStore.c matrixScalapackStore.c     -lmpi -mkl -lmkl_scalapack_lp64 -lmkl_blacs_sgimpt_lp64 -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -L$MKL_LIB
 * 
 * assume that 
